...
@Component({
  ...
  template: `
    <section class="auth-card">
      <header>
        <mat-icon aria-hidden="true" class="auth-card__icon">block</mat-icon>
        <h1>{{ 'authentication.accessDenied.title' | translate }}</h1>
        <p>{{ 'authentication.accessDenied.description' | translate }}</p>
      </header>
